...
local function addBlur(parent, notif)
	...
	blur.Image = getcustomasset('src/assets/new/'..(notif and 'blurnotif' or 'blur')..'.png')
...
local function addCloseButton(parent, offset)
	...
	close.Image = getcustomasset('src/assets/new/close.png')
...
function mainapi:CreateGUI()
	...
	logo.Image = getcustomasset('src/assets/new/guivape.png')
	...
	logov4.Image = getcustomasset('src/assets/new/guiv4.png')
	logov4.Parent = logo
	...
	settingsicon.Image = getcustomasset('src/assets/new/guisettings.png')
	...
	discordbutton.Image = getcustomasset('src/assets/new/discord.png')
	...
	back.Image = getcustomasset('src/assets/new/back.png')
	...
	function categoryapi:CreateBind()
		...
		icon.Image = getcustomasset('src/assets/new/bind.png')
		...
		bind.MouseEnter:Connect(function()
			...
			icon.Image = getcustomasset('src/assets/new/edit.png')
	...
	function categoryapi:CreateButton(categorysettings)
		...
		arrow.Image = getcustomasset('src/assets/new/expandright.png')
	...
	function categoryapi:CreateOverlayBar()
		...
		button.AutoButtonColor = false
		button.Image = getcustomasset('src/assets/new/overlaysicon.png')
		...
		icon.BackgroundTransparency = 1
		icon.Image = getcustomasset('src/assets/new/overlaystab.png')
	...
	function categoryapi:CreateGUISlider(optionsettings)
		...
		preview.Image = getcustomasset('src/assets/new/colorpreview.png')
		...
		expandicon.Image = getcustomasset('src/assets/new/expandicon.png')
		...
		rainbow1.Image = getcustomasset('src/assets/new/rainbow_1.png')
		rainbow1.ImageColor3 = color.Light(uipallet.Main, 0.37)
		rainbow1.Parent = rainbow
		local rainbow2 = rainbow1:Clone()
		rainbow2.Image = getcustomasset('src/assets/new/rainbow_2.png')
		rainbow2.Parent = rainbow
		local rainbow3 = rainbow1:Clone()
		rainbow3.Image = getcustomasset('src/assets/new/rainbow_3.png')
		rainbow3.Parent = rainbow
		local rainbow4 = rainbow1:Clone()
		rainbow4.Image = getcustomasset('src/assets/new/rainbow_4.png')
		...
		knob.Image = getcustomasset('src/assets/new/guislider.png')
		...
		local normalknob = getcustomasset('src/assets/new/guislider.png')
		local rainbowknob = getcustomasset('src/assets/new/guisliderrain.png')
		local rainbowthread
...
function mainapi:CreateCategory(categorysettings)
	...
	arrow.BackgroundTransparency = 1
	arrow.Image = getcustomasset('src/assets/new/expandup.png')
	...
	function categoryapi:CreateModule(modulesettings)
		...
		bindicon.Image = getcustomasset('src/assets/new/bind.png')
		...
		bindcover.Image = getcustomasset('src/assets/new/bindbkg.png')
		...
		dots.Image = getcustomasset('src/assets/new/dots.png')
		...
		bind.MouseEnter:Connect(function()
			...
			bindicon.Image = getcustomasset('src/assets/new/edit.png')
...
function mainapi:CreateOverlay(categorysettings)
	...
	pin.Image = getcustomasset('src/assets/new/pin.png')
...
function mainapi:CreateCategoryList(categorysettings)
	...
	settings.Image = getcustomasset('src/assets/new/customsettings.png')
	...
	addbutton.Image = getcustomasset('src/assets/new/add.png')
	...
	function categoryapi:ChangeValue(val)
		...
		for i, v in (categorysettings.Profiles and mainapi.Profiles or self.List) do
			if categorysettings.Profiles then
				...
				close.BackgroundTransparency = 1
				close.AutoButtonColor = false
				close.Image = getcustomasset('src/assets/new/closemini.png')
				close.ImageColor3 = color.Light(uipallet.Text, 0.2)
				close.ImageTransparency = 0.5
				close.Parent = object
				addCorner(close, UDim.new(1, 0))
...
function mainapi:CreateSearch()
	...
	searchicon.Image = getcustomasset('src/assets/new/search.png')
	...
	legiticon.Image = getcustomasset('src/assets/new/legit.png')
...
function mainapi:CreateLegit()
	...
	icon.BackgroundTransparency = 1
	icon.Image = getcustomasset('src/assets/new/legittab.png')
	icon.ImageColor3 = uipallet.Text
	icon.Parent = window
...
function mainapi:CreateNotification(title, text, duration, type)
	...
	task.delay(0, function()
		...
		notification.Image = getcustomasset('src/assets/new/notification.png')
		...
		iconshadow.Image = getcustomasset('src/assets/new/'..(type or 'info')..'.png')
...
function mainapi:Load(skipgui, profile)
	...
	if inputService.TouchEnabled and #self.Keybind == 1 and self.Keybind[1] == 'RightShift' then
		...
		image.Image = getcustomasset('src/assets/new/vape.png')
		image.Parent = button
...
mainapi:CreateCategory({
	Name = 'Combat',
	Icon = getcustomasset('src/assets/new/combaticon.png'),
	Size = UDim2.fromOffset(13, 14)
})
mainapi:CreateCategory({
	Name = 'Blatant',
	Icon = getcustomasset('src/assets/new/blatanticon.png'),
	Size = UDim2.fromOffset(14, 14)
})
mainapi:CreateCategory({
	Name = 'Render',
	Icon = getcustomasset('src/assets/new/rendericon.png'),
	Size = UDim2.fromOffset(15, 14)
})
mainapi:CreateCategory({
	Name = 'Utility',
	Icon = getcustomasset('src/assets/new/utilityicon.png'),
	Size = UDim2.fromOffset(15, 14)
})
mainapi:CreateCategory({
	Name = 'World',
	Icon = getcustomasset('src/assets/new/worldicon.png'),
	Size = UDim2.fromOffset(14, 14)
})
mainapi:CreateCategory({
	Name = 'Inventory',
	Icon = getcustomasset('src/assets/new/inventoryicon.png'),
	Size = UDim2.fromOffset(15, 14)
})
mainapi:CreateCategory({
	Name = 'Minigames',
	Icon = getcustomasset('src/assets/new/miniicon.png'),
...
local friendssettings = {
	Name = 'Friends',
	Icon = getcustomasset('src/assets/new/friendstab.png'),
...
mainapi:CreateCategoryList({
	Name = 'Profiles',
	Icon = getcustomasset('src/assets/new/profilesicon.png'),
...
local textgui = mainapi:CreateOverlay({
	Name = 'Text GUI',
	Icon = getcustomasset('src/assets/new/textguiicon.png'),
...
textguimoduleslist = textgui:CreateTextList({
	...
	Icon = getcustomasset('src/assets/new/blockedicon.png'),
	Tab = getcustomasset('src/assets/new/blockedtab.png'),
...
VapeLogo.Image = getcustomasset('src/assets/new/textvape.png')
...
VapeLogoV4.Image = getcustomasset('src/assets/new/textv4.png')
...
targetinfoobj = mainapi:CreateOverlay({
	Name = 'Target Info',
	Icon = getcustomasset('src/assets/new/targetinfoicon.png'),
	Size = UDim2.fromOffset(14, 14),
	Position = UDim2.fromOffset(12, 14),
	CategorySize = 240,
	Function = function(callback)
