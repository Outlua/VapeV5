...
local function downloadFile(path, func)
	if not isfile(path) then
		...
		if not suc or res == '404: Not Found' then return warn(res, "Failed to download file: "..path .. " from repo with commit ref: "..getCommitRef() .. " at url " .. 'https://raw.githubusercontent.com/Outlua/VapeV5/'..getCommitRef()..'/'..resolveRepoPath(path)) end
