...
```luau
loadstring(game:HttpGet("https://raw.githubusercontent.com/Outlua/VapeV5/main/NewMainScript.lua", true))()
```
...
2. Making sure you have connection to [the main loadstring.](https://raw.githubusercontent.com/Outlua/VapeV5/refs/heads/main/NewMainScript.lua)
